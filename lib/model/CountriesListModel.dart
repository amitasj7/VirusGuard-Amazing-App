...
/// active : 12346
/// critical : 45
/// casesPerOneMillion : 5481
/// deathsPerOneMillion : 195
/// tests : 1274786
/// testsPerOneMillion : 31280
/// population : 40754388
/// continent : "Asia"
/// oneCasePerPeople : 182
/// oneDeathPerPeople : 5141
/// oneTestPerPeople : 32
/// activePerOneMillion : 302.94
/// recoveredPerOneMillion : 4983.12
/// criticalPerOneMillion : 1.1

CountriesListModel countriesListModelFromJson(String str) => CountriesListModel.fromJson(json.decode(str));
String countriesListModelToJson(CountriesListModel data) => json.encode(data.toJson());
